...
class TestUpdateCategoryTasks:
    ...
    def test_update_category_views_task(self) -> None:
        # Completing the task
        result = update_category_views_task(1)
    ...
    def test_update_category_purchase_task(self) -> None:
        # Completing the task
        result = update_category_purchase_task(1)
