...
class TestReviewManager:
    ...
    def setup(self, mocker: MockFixture) -> None:
    ...
    def test_check_instance(self, rise_exception: bool) -> None:
        if rise_exception:
    ...
    def test_make_review(self, mocker: MockFixture, review_exists: bool) -> None:
    ...
    @pytest.mark.parametrize("review_exists", (True, False))
    def test_update_review(self, mocker: MockFixture, review_exists: bool) -> None:
    ...
    @pytest.mark.parametrize("review_exists", (True, False))
    def test_remove_review(self, mocker: MockFixture, review_exists: bool) -> None:
        review_by_user = self.review_object if review_exists else None
...
class TestUserReviewManager:
    ...
    def test_get_reviews(self, mocker: MockFixture) -> None:
        # Mock dependencies
    ...
    def test_get_review_by_user(self, mocker: MockFixture, reviews_exists: bool) -> None:
        mock_review = mocker.MagicMock() if reviews_exists else None

        # Mock QuerySet
        mock_queryset = mocker.MagicMock(spec=QuerySet)
        mock_queryset.filter.return_value = mock_queryset
        mock_queryset.first.return_value = mock_review
