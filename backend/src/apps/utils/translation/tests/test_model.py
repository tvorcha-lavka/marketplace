...
class TestAutoTranslatableModel:
    ...
    def test_add_translate_task(self, mocker: MockerFixture) -> None:
    ...
    def test_get_translated_fields(self) -> None:
    ...
    def test_translate_field(self, mocker: MockerFixture) -> None:
    ...
    def test_translate(self, mocker: MockerFixture) -> None:
    ...
    def test_translate_with_connection_error(self, mocker: MockerFixture) -> None:
    ...
    def test_list_formatting(self, mocker: MockerFixture) -> None:
