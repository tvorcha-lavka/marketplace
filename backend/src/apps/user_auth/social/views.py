...
from apps.email.notifications import notify_user_successful_registration
...
class SocialOAuth2RedirectView(GenericAPIView[Any], BackendMixin):
...
class SocialOAuth2CallbackView(CreateAPIView[Any], TokenMixin, BackendMixin):
    ...
    def post(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        ...
        try:
            user = backend.complete()  # type: ignore[no-untyped-call]
