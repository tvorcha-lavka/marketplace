    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("slug", models.SlugField(blank=True, unique=True, verbose_name="slug")),
                ("groups", models.ManyToManyField(to="filter.filtergroup", verbose_name="filter groups")),
            ],
            options={
                "verbose_name": "filter group set",
                "verbose_name_plural": "filter group sets",
        ...
        migrations.AddField(
            model_name="filtergroup",
            name="filter_values",
            field=models.ManyToManyField(to="filter.filtervalue", verbose_name="filter values"),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name="FilterGroupSetTranslation",
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("language_code", models.CharField(db_index=True, max_length=15, verbose_name="Language")),
                ...
                (
                    ...
                    parler.fields.TranslationsForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="translations",
                        to="filter.filtergroupset",
                    ),
                ),
            ],
            options={
                "verbose_name": "filter group set Translation",
                "db_table": "filter_group_set_translation",
                "db_tablespace": "",
                "managed": True,
                "default_permissions": (),
