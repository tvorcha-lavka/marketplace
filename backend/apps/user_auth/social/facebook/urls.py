...
FacebookOAuth2RedirectView = extend_schema(tags=[SchemaTag], auth=[])(FacebookOAuth2RedirectView)
FacebookOAuth2CallbackView = extend_schema(tags=[SchemaTag], auth=[])(FacebookOAuth2CallbackView)
